...
public final class MineflayerApiSurfaceMatrixTest {
    ...
    public static void main(String[] args) {
        ...
        for (String group : Set.of("core_state", "world_query", "movement_pathfinder", "block_mutation", "item_entity_combat",
                "inventory_window", "recipes_crafting", "containers", "chat_settings", "resource_pack",
        ...
        AICoreTestSupport.requireStatus("use_on_entity", CapabilityStatus.IMPLEMENTED_WITH_SERVER_SIDE_SEMANTICS);

...
- `common`: loader-neutral constants, lifecycle seams, and pure Java command intent types.
...
Phase 1 is a buildable foundation only. It does not implement NPC entities, networking, GUI, skin loading, pathfinding automation, or LLM provider calls.
